...
class DINOv3ModelWithLoRA(nn.Module):
    def __init__(self, name, num_classes=1, lora_rank=8, lora_alpha=1.0, lora_targets=None,
        ...
        try:
            ...
            raise ImportError("LoRA module not found. Please ensure the LoRA utilities are available.")
        ...
        print(f"Adding LoRA to DINOv3 model '{name}' (rank={lora_rank}, alpha={lora_alpha})")
