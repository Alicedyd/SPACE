...
def get_model(name, lora_rank=8, lora_alpha=1.0, lora_targets=None, huggingface_path=None):
    ...
    if name.startswith("Imagenet:"):
        ...
        if model_type == "dinov2_vitl14" and huggingface_path is None:
            ...
            print(f"  - Using default HuggingFace path for dinov2_vitl14: {huggingface_path}")
        ...
        if model_type == "dinov2_vitl14_register" and huggingface_path is None:
            ...
            print(f"  - Using default HuggingFace path for register model: {huggingface_path}")
        ...
        if model_type == "dinov3_vitl16" and huggingface_path is None:
            huggingface_path = "/inspire/hdd/project/wuliqifa/public/dda/dinov3/pth-vitl16-lvd"
            print(f"  - Using default HuggingFace path for dinov3_vitl16: {huggingface_path}")
