...
# FLUX 336 focalloss
# CKPT="/root/autodl-tmp/codes/ckpt/checkpoints_DINO_336_LR1e-4_single_run/EXP_flux_logitadjustment_DINO_336_JPEGaug_lora8_lr1e-4_BS_16_ACC_4_colorspace_RGB/model_iters_80000.pth"
...
RESULT_FOLDER="./result/dda_GenImage/"
CONFIG_FILE="../val_configs/GenImage.yaml"
CROP_SIZE=336
# ===== TRAINING PARAMETERS =====
LORA_RANK=8
LORA_ALPHA=1
